(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                bodyLockToggle();
                const subRemMenu = document.querySelectorAll(".sub-menu");
                document.documentElement.classList.toggle("menu-open");
                subRemMenu.forEach((element => {
                    element.classList.remove("menu-open-sub");
                    element.classList.remove("menu-open-sub-sub");
                }));
            }
        }));
    }
    ...
    function initSliders() {
        ...
        if (document.querySelector(".about__slider ")) {
            const thumbsSwiper = new core(".about-thumb__slider", {
                ...
                direction: "horizontal",
                navigation: {
                    prevEl: ".about__navigacon-prev",
                    nextEl: ".about__navigacon-next"
                },
                breakpoints: {
                    768: {
                        direction: "vertical"
        ...
        if (document.querySelector(".look__slider")) new core(".look__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            simulateTouch: false,
            navigation: {
                prevEl: ".look-button-prev",
                nextEl: ".look-button-next"
            },
            on: {}
        });
        ...
        if (document.querySelector(".material__slider")) new core(".material__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.7,
...
***************************************************************************** */
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        phoneInputs.forEach((function(phoneInput) {
            phoneInput.addEventListener("focus", (function() {
                if ("" === phoneInput.value) phoneInput.value = "+375 (__) ___-__-__";
            }));
            phoneInput.addEventListener("blur", (function() {
                if ("+375 (__) ___-__-__" === phoneInput.value) phoneInput.value = "";
            }));
            phoneInput.addEventListener("input", (function() {
                ...
                if (value.length >= 11) formattedValue += "-" + value.substring(10, 12);
    ...
    function documentActions(e) {
        ...
        if (menuBody.contains(targetElement) && targetElement.closest(".menu__link--arrow")) {
            const subMenu = targetElement.nextElementSibling;
            if (subMenu && subMenu.classList.contains("sub-menu")) {
                const openSubMenus = menuBody.querySelectorAll(".sub-menu.menu-open-sub");
                openSubMenus.forEach((menu => {
                    if (menu !== subMenu) menu.classList.remove("menu-open-sub");
                }));
                subMenu.classList.toggle("menu-open-sub");
            }
        }
        if (menuBody.contains(targetElement) && targetElement.closest(".sub-menu-arrow")) {
            const subSubMenu = targetElement.nextElementSibling;
            if (subSubMenu && subSubMenu.classList.contains("sub-menu")) {
                const openSubSubMenus = menuBody.querySelectorAll(".sub-menu.menu-open-sub-sub");
                openSubSubMenus.forEach((menu => {
                    if (menu !== subSubMenu) menu.classList.remove("menu-open-sub-sub");
                }));
                subSubMenu.classList.toggle("menu-open-sub-sub");
            }
        }
        if (menuBody.contains(targetElement) && targetElement.closest(".sub-menu-cloze")) {
            const subMenuToClose = targetElement.closest(".sub-menu");
            if (subMenuToClose) subMenuToClose.classList.remove("menu-open-sub", "menu-open-sub-sub");
        }
    }
    const files = document.querySelectorAll(".input-file input[type=file]");
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        sliders.forEach((slider => {
            ...
            document.body.addEventListener("touchmove", (e => {
                if (!isActive) return;
                let x;
                for (let i = 0; i < e.changedTouches.length; i++) x = e.changedTouches[i].pageX;
                x -= slider.getBoundingClientRect().left;
                beforeAfterSlider(x);
                pauseEvents(e);
            }));
